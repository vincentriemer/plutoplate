...
public class PlutoplateView {
	...
	public void createView() {
		...
		Dimension imgSize = new Dimension(backgroundImage.getWidth(null) + 10, backgroundImage.getHeight(null) + 50);
		...
		this.motorPosition = new JSlider(0, 0, 100, 0);
		...
		this.saveAsPreset.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
							...
							if (name.length() > 0) {
								if (PlutoplateView.this.model.getPresetDB().getPreset(name) == null) {
									...
									if ((PlutoplateView.this.actualPosition.getText() != null)
										...
										position = Integer.valueOf(
												Integer.parseInt(PlutoplateView.this.actualPosition.getText()));
									}
	...
	private void constructHelp() {
		...
		helpSubMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, "Coming Soon", "Help Information", 1);
			}
		});
		JMenuItem infoSubMenu = new JMenuItem("About " + FRAME_LABEL);
		infoSubMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(PlutoplateView.this.viewframe, "Version 1.1.0 - 2014",
						"About" + PlutoplateView.FRAME_LABEL, 1);
			}
		});
